...
const About_section = () => {
    return (
        <div className="bg-gray-100">
            ...
            {/* Features Section */}
            <section className="sm:w-10/12 w-full mx-auto py-12 ">
            ...
            <section className="bg-gray-200 py-12 sm:w-10/12 w-full mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="text-center border border-[#20319e83] rounded-md py-4">
                        ...
                        <p className='sm:px-4'>HR Managers or employees sign up to start managing their assets.</p>
                    </div>
                    <div className="text-center border border-[#20319e83] rounded-md py-4">
            ...
            <section className="sm:w-10/12 mx-auto w-full py-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-white shadow-lg p-6 rounded-lg border hover:border-[#20319ee7] duration-300">
                        ...
                        <span className="block text-right text-gray-600">- John Doe, HR Manager</span>
                    </div>
                    <div className="bg-white shadow-lg p-6 rounded-lg border hover:border-[#20319ee7] duration-300">
                        <p>"Requesting and returning items has never been easier. Highly recommend it!"</p>
                        <span className="block text-right text-gray-600">- Sarah Lee, Employee</span>
                    </div>
                </div>
            </section>

            {/* Call-to-Action Section */}
            <section className="bg-[#031278] text-white text-center py-12">
