...
export default function Add_HR_Manager() {
  ...
  const newAddEmployee = { userName,companyName, email,password, userImage, companyLogo,
     date, }
  ...
  return (
    ...
    <div className="bg-base-100 w-full md:w-11/12 mx-auto shadow-sm md:px-10 px-4 my-10 pt-4 pb-10">
        <h2 className="md:text-4xl text-2xl text-gray-800 font-extrabold pb-2 text-center"> Add HR Manager</h2>
        <p className="text-md text-gray-600 font-medium text-center md:w-1/2 mx-auto">Start your journey as a HR Manager! Create a new HR Managers to share your unique ideas,
      ...
      <form onSubmit={handleSubmit} className="mt-8">
        <div className='grid md:grid-cols-2 grid-cols-1 gap-6'>
          ...
          <div>
            ...
            type="text"
            name="companyName"
            placeholder='Enter your Company Name'  className="w-full outline-none
             px-3 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-1
              focus:ring-[#60e49991]" required />
          </div>
          <div>
            ...
            type="text"
            name="companyLogo"
            placeholder='Enter your Company Logo URL'  className="w-full outline-none
             px-3 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-1
              focus:ring-[#60e49991]" required />
          </div>
